...
func (c *cli) helpExtensions() {
	...
	c.hline("  PERF/FUSION: a UDF call boxes its whole .multi query (forfeits index pruning); keep")
	c.hline("  UDFs out of a wide-scan detector and apply them in a downstream .multi compose node.")
