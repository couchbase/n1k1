...
/* width is user-resizable (drag the right edge) so long entries needn't stay clipped */
.toc{flex:none;width:238px;min-width:150px;max-width:60vw;resize:horizontal;
  overflow:auto;border-right:1px solid var(--line);background:var(--bg);padding:6px 0 24px}
