...
`,
	...
	naryProjectCase("trim", []interface{}{"trim", []interface{}{"json", `"  hi \t"`}}, `"hi"`),
	naryProjectCase("ltrim", []interface{}{"ltrim", []interface{}{"json", `"  hi  "`}}, `"hi  "`),
	naryProjectCase("rtrim", []interface{}{"rtrim", []interface{}{"json", `"  hi  "`}}, `"  hi"`),
	naryProjectCase("trim-num", []interface{}{"trim", []interface{}{"json", `5`}}, `null`),
	naryProjectCase("reverse", []interface{}{"reverse", []interface{}{"json", `"abc"`}}, `"cba"`),
	naryProjectCase("reverse-num", []interface{}{"reverse", []interface{}{"json", `5`}}, `null`),
	naryProjectCase("replace", []interface{}{"replace",
		[]interface{}{"json", `"banana"`}, []interface{}{"json", `"a"`}, []interface{}{"json", `"o"`}}, `"bonono"`),
	naryProjectCase("replace-del", []interface{}{"replace",
		[]interface{}{"json", `"a-b-c"`}, []interface{}{"json", `"-"`}, []interface{}{"json", `""`}}, `"abc"`),
	naryProjectCase("replace-null", []interface{}{"replace",
		[]interface{}{"json", `null`}, []interface{}{"json", `"a"`}, []interface{}{"json", `"o"`}}, `null`),
	naryProjectCase("substr0-2", []interface{}{"substr0_2",
		[]interface{}{"json", `"hello"`}, []interface{}{"json", `1`}}, `"ello"`),
	naryProjectCase("substr0-2-neg", []interface{}{"substr0_2",
		[]interface{}{"json", `"hello"`}, []interface{}{"json", `-2`}}, `"lo"`),
	naryProjectCase("substr0-3", []interface{}{"substr0_3",
		[]interface{}{"json", `"hello"`}, []interface{}{"json", `1`}, []interface{}{"json", `3`}}, `"ell"`),
	naryProjectCase("substr0-3-clamp", []interface{}{"substr0_3",
		[]interface{}{"json", `"hello"`}, []interface{}{"json", `3`}, []interface{}{"json", `9`}}, `"lo"`),
	naryProjectCase("substr1-2", []interface{}{"substr1_2",
		[]interface{}{"json", `"hello"`}, []interface{}{"json", `2`}}, `"ello"`),
	naryProjectCase("substr0-2-oor", []interface{}{"substr0_2",
		[]interface{}{"json", `"hello"`}, []interface{}{"json", `5`}}, `null`),
	naryProjectCase("substr0-3-num", []interface{}{"substr0_3",
		[]interface{}{"json", `5`}, []interface{}{"json", `1`}, []interface{}{"json", `2`}}, `null`),
	naryProjectCase("split-ws", []interface{}{"split_1",
		[]interface{}{"json", `"a b  c"`}}, `["a","b","c"]`),
	naryProjectCase("split-empty", []interface{}{"split_1",
		[]interface{}{"json", `"  "`}}, `[]`),
	naryProjectCase("split-sep", []interface{}{"split_2",
		[]interface{}{"json", `"a,b,c"`}, []interface{}{"json", `","`}}, `["a","b","c"]`),
	naryProjectCase("split-sep-null", []interface{}{"split_2",
		[]interface{}{"json", `null`}, []interface{}{"json", `","`}}, `null`),
	naryProjectCase("lpad-2", []interface{}{"lpad_2",
		[]interface{}{"json", `"ab"`}, []interface{}{"json", `5`}}, `"   ab"`),
	naryProjectCase("rpad-2", []interface{}{"rpad_2",
		[]interface{}{"json", `"ab"`}, []interface{}{"json", `5`}}, `"ab   "`),
	naryProjectCase("lpad-3", []interface{}{"lpad_3",
		[]interface{}{"json", `"ab"`}, []interface{}{"json", `5`}, []interface{}{"json", `"*"`}}, `"***ab"`),
	naryProjectCase("rpad-3-multi", []interface{}{"rpad_3",
		[]interface{}{"json", `"ab"`}, []interface{}{"json", `7`}, []interface{}{"json", `"xy"`}}, `"abxyxyx"`),
	naryProjectCase("lpad-trunc", []interface{}{"lpad_2",
		[]interface{}{"json", `"abcde"`}, []interface{}{"json", `3`}}, `"abc"`),
	naryProjectCase("lpad-emptypad", []interface{}{"lpad_3",
		[]interface{}{"json", `"ab"`}, []interface{}{"json", `5`}, []interface{}{"json", `""`}}, `null`),
	naryProjectCase("round-1", []interface{}{"round_1", []interface{}{"json", `2.7`}}, `3`),
	naryProjectCase("round-half-even", []interface{}{"round_1", []interface{}{"json", `2.5`}}, `2`),
	naryProjectCase("round-2", []interface{}{"round_2",
		[]interface{}{"json", `3.14159`}, []interface{}{"json", `2`}}, `3.14`),
	naryProjectCase("round-negp", []interface{}{"round_2",
		[]interface{}{"json", `1234.5`}, []interface{}{"json", `-2`}}, `1200`),
	naryProjectCase("trunc-1", []interface{}{"trunc_1", []interface{}{"json", `2.9`}}, `2`),
