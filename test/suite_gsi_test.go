...
var gsiExpectedNonPass = map[string]string{
	...
	"case_gsi_conditional_unkn_functions.json[14]": "results-differ",
	"case_gsi_conditional_unkn_functions.json[15]": "results-differ",
	...
	"case_gsi_select_functions.json[10]":           "results-differ",
	"case_gsi_select_functions.json[14]":           "results-differ",
	"case_gsi_typeconv_functions.json[20]":         "results-differ",
}
...
var gsiGroupWhy = map[string]string{
	...
	"results-differ":      "results differ from cbq (object/JSON key order, tie-broken LIMIT, or a real gap) -- to investigate",
}
